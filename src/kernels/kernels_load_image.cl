...
__kernel void compute_SE3_param_maps(
...
*/
		...
		if(global_id_u==0)printf("\n__kernel void compute_SE3_param_maps(..) i=%u, (read_index + i* uint_params[MM_PIXELS]) = %u,  partial_gradient=(%f, %f)",\
																			 i,    (read_index + i* uint_params[MM_PIXELS]), 		partial_gradient.x, partial_gradient.y );
